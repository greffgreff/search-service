...
public class Errors {
    ...
    public static final ResponseStatusException LISTING_NOT_FOUND = new ResponseStatusException(HttpStatus.NOT_FOUND, "Could not find listing with specified arguments.");
